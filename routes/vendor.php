...
use App\Http\Controllers\Backend\VendorOrderControlelr;
use App\Http\Controllers\Backend\VendorOrderController;
use App\Http\Controllers\Backend\VendorProductController;
use App\Http\Controllers\Backend\VendorProductImageGalleryController;
use App\Http\Controllers\Backend\VendorProductReviewsController;
...
Route::delete('products-variant-item/{id}', [VendorProductVariantItemController::class, 'destroy'])->name('products-variant-item.destroy');
...
Route::get('orders-status/{id}', [VendorOrderController::class, 'changeOrderStatus'])->name('orders.status');

Route::get('product-review', [ VendorProductReviewsController::class, 'index'])->name('review.index');
/** Withdraw route */
