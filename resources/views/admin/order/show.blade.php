                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <address>
                                        ...
                                        <b>Adress: </b> {{ $address->address }} <br>
                                        <b>City: </b> {{ $address->city }} ,<b>State: </b> {{ $address->state }} ,<b>Zip:
                                        </b> {{ $address->zip }}<br>
                                    ...
                                    @foreach ($order->orderProducts as $product)
                                        ...
                                        <tr>
                                            ...
                                            @if (isset($product->product->slug))
                                                <td style="width: 300px"><a target="_blank"
                                            ...
                                            <td>
                                                @foreach ($variants as $key => $variant)
                                                    ...
                                                    {{ $settings->currency_icon }}{{ $variant->price }} ) <br>
                                                @endforeach
                                            </td>
                            ...
                            <div class="row mt-4">
                                <div class="col-lg-8">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <select name="order_payment" class="form-control" data-id="{{ $order->id }}"
                                                id="order_payment">
                                ...
                                <div class="col-lg-4 text-right">
                                        ...
                                        <div class="invoice-detail-value">{{ $settings->currency_icon }}
                                            {{ @$coupon->discount
                                                ? (@$coupon->discount_type == 'percent'
                                                    ? (@$coupon->discount * $order->sub_total) / 100
                                                    : @$coupon->discount)
                                                : 0 }}
                                        </div>
                                    </div>
                                    ...
                                    {{-- <div class="invoice-detail-value">
                                        {{ $order->currency_icon }}{{ @$coupon->discount ? (@$coupon->discount_type == 'percent' ? (@$coupon->discount * $order->sub_total) / 100
                                                : @$coupon->discount)
                                            : 0 }}
                                    </div> --}}
