                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <select id="inputState" class="form-control sub-category select2" name="discount_type">
                                      <option {{$coupon->discount_type=='percent'? 'selceted':''}} value="percent">Percentage (%)</option>
                                      <option {{$coupon->discount_type=='amount'? 'selceted':''}} value="amount">Amount ({{$settings->currency_icon}})</option>
                                    </select>
                                </div>
                            </div>
                            <div class="col-md-8">
