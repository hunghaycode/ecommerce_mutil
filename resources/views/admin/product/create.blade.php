                        ...
                        <div class="card-body">
                            <form action="{{ route('admin.products.store') }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    ...
                                    <select id="inputState" class="form-control  select2" name="brand" value="">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea name="long_description" id="" class="summernote" cols="30" rows="10">{{ old('long_description') }}</textarea>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <select id="inputState" class="form-control select2" name="product_type" value="{{ old('product_type') }}">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea name="seo_description" id="" class="summernote" cols="30" rows="10">{{ old('seo_description') }}</textarea>
                                </div>
                                <div class="form-group">
