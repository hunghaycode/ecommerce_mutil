<section id="wsus__hot_deals" class="wsus__hot_deals_2">
    <div class="container">
        ...
        <div class="wsus__hot_large_item">
            <div class="row">
                <div class="col-xl-12">
                    <div class="wsus__section_header justify-content-center">
                        <div class="monthly_top_filter2 mb-1">
                            <button style="font-size: 18px" data-filter=".new_arrival">New</button>
                            <button style="font-size: 18px" data-filter=".featured_product">Featured</button>
                            <button style="font-size: 18px" data-filter=".top_product">Top</button>
                            <button style="font-size: 18px" data-filter=".best_product">Best</button>
