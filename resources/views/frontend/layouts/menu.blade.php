            ...
            <div class="col-xl-12">
                <div class="relative_contect d-flex">
                                ...
                                @if (count($category->subCategories) > 0)
                                    <ul class="wsus_menu_cat_droapdown">
                                        @foreach ($category->subCategories as $subCategory)
                                            <li><a href="{{route('products.index',['sub_category'=>$subCategory->slug])}}">{{ $subCategory->name }} <i
                    ...
                    <ul class="wsus__menu_item">
                        ...
                        <li><a href="{{route('products.index')}}">shop <i class="fas fa-caret-down"></i></a>
                           
                        </li>
                        <li><a href="{{route('user.vendor-page.index')}}">vendor</a></li>
                        ...
                        <li><a href="{{route('user.orders-tracking')}}">track order</a></li>
                    ...
                    <ul class="wsus__menu_item wsus__menu_item_right">
                        ...
                        <li><a href="{{route('user.dashboard')}}">Vendor Dashboard</a></li>
                        ...
                        <div id="flush-collapseThreew-{{$loop->index}}" class="accordion-collapse collapse"
                            ...
                            <div class="accordion-body">
                                <ul>
                                    ...
                                    <li><a href="{{route('products.index',['sub_category'=>$subCategoryItem->slug])}}">{{$subCategoryItem->name}}</a></li>
            ...
            <div class="wsus__mobile_menu_main_menu">
                <div class="accordion accordion-flush" id="accordionFlushExample2">
                    <ul>
                        ...
                        <li><a href="{{route('products.index')}}" class="accordion-button collapsed" data-bs-toggle="collapse"
