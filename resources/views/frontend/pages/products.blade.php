                ...
                <div class="col-xl-9 col-lg-8">
                    <div class="row">
                            ...
                            <div class="wsus__product_topbar">
                                <div class="wsus__product_topbar_left">
                                    <div class="nav nav-pills" id="v-pills-tab" role="tablist"
                                        ...
                                        <button
                                            class="nav-link list-views {{ session()->has('product-list-view') && session()->get('product-list-view') == 'grid' ? 'active' : '' }}  {{ !session('product-list-view') ? ' active' : '' }}"
                                        ...
                                        <button
                                            class="nav-link list-views {{ session()->has('product-list-view') && session()->get('product-list-view') == 'list' ? 'active' : '' }}"
                        ...
                        <div class="tab-content" id="v-pills-tabContent">
                            <div class="tab-pane fade  {{ session()->has('product-list-view') && session()->get('product-list-view') == 'grid' ? 'show active' : '' }} {{ !session('product-list-view') ? 'show active' : '' }}"
                            ...
                            <div class="tab-pane fade {{ session()->has('product-list-view') && session()->get('product-list-view') == 'list' ? 'show active' : '' }} "
                                                ...
                                                <div class="wsus__product_details">
                                                    ...
                                                    @else
                                                        <p class="wsus__price">{{ $settings->currency_icon }}
                                                            {{ $product->price }} </p>
                                                    @endif
                                                    <p class="list_description">{!! limitText($product->short_description,200) !!}</p>
                                                    <form action="" class="shopping-cart-form">
                                                        <div class="wsus__selectbox">
                                                            <div class="row">
                                                                <input type="hidden" name="product_id"
                                                            ...
                                                            <button class="add_cart" type="submit" href="#">add to cart</button>
                                                            <button class="product-detail" type="submit" href="{{ route('product-detail', $product->slug) }}">chi tiết</button>
                                                        </div>
                                                        <input type="hidden" min="1" max="100"
                                                            value="1" name="qty" />
