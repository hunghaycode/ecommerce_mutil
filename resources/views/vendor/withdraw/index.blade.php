    ...
    <div class="container-fluid">
      ...
      <div class="row">
        <div class="col-xl-9 col-xxl-10 col-lg-9 ms-auto">
            ...
            <h3><i class="far fa-user mb-4"></i> All Withdraw</h3>
                ...
                <div class="row ">
                    ...
                    <div class="col-md-4">
                        <a class="wsus__dashboard_item red" href="{{route('vendor.orders.index')}}">
                          ...
                          <p>Current Balance</p>
                          <h4 >{{ $settings->currency_icon }} {{ $currentBalance }}</h4>
                      ...
                      <div class="col-md-4">
                        <a class="wsus__dashboard_item red" href="{{route('vendor.orders.index')}}">
                          ...
                          <h4 >{{ $settings->currency_icon }} {{ $pendingAmount }}</h4>
                        </a>
                      </div>
                      ...
                      <div class="col-md-4">
                        <a class="wsus__dashboard_item red" href="{{route('vendor.orders.index')}}">
                          ...
                          <h4 >{{ $settings->currency_icon }} {{ $totalWithdraw }}</h4>
                        </a>
                      </div>
                </div>
            </div>
