        ...
        ->addColumn('action', function($query){
            ...
            $moreBtn = '<div class="btn-group dropstart" style="margin-left:3px">
                ...
                <ul class="dropdown-menu">
                    <a class="dropdown-item" href="'.route('vendor.products-image-gallery.index',['product'=>$query->id]).'">Image Gallery</a>
                      <a class="dropdown-item" href="'.route('vendor.products-variant.index',['product'=>$query->id]).'">Product Variant</a>
                </ul>
            </div>';
