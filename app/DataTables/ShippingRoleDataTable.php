...
class ShippingRoleDataTable extends DataTable
{
    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ->addColumn('action', function ($query) {
                $editBtn = "<a href='" . route('admin.shipping-role.edit', $query->id) . "' class='btn btn-primary' ><i class='far fa-edit'> </i></a> ";
                $deleteBtn = "<a href='" . route('admin.shipping-role.destroy', $query->id) . "' class='btn btn-danger ml-1 delete-item' ><i class='far fa-trash-alt'> </i></a> ";
     ...
     */
    public function query(ShippingRole $model): QueryBuilder
    {
    ...
    {
        return 'ShippingRole_' . date('YmdHis');
    }
}
