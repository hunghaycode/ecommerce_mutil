...
use App\Models\SellerProductsPending;
...
class SellerProductsPendingDataTable extends DataTable
{
    /**
    ...
    {
        return $this->builder()
            ->setTableId('sellerproductspending-table')
    ...
    {
        return 'SellerProductsPending_' . date('YmdHis');
    }
}
